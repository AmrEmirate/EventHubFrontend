...
import CountdownTimer from '@/components/ui/countdown-timer'; // <-- 1. Impor komponen CountdownTimer
...
export default function TransactionsPage() {
  ...
  const handleFileChange = async (event: React.ChangeEvent<HTMLInputElement>) => {
    if (!event.target.files || event.target.files.length === 0 || !selectedTransactionId) {
      return;
    }
                    ...
                    <TableRow key={trx.id}>
                      ...
                      <TableCell>
                        <div className="flex flex-col gap-1 items-start">
                          ...
                          {/* 2. Tampilkan CountdownTimer HANYA jika status PENDING_PAYMENT */}
